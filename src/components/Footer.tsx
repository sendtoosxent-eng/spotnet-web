...
export default function Footer() {
    return (
        <footer className="flex flex-wrap justify-center md:justify-between overflow-hidden gap-10 md:gap-20 mt-40 py-6 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500">
            ...
            >
                <a href="#">
                    <img className="size-8 aspect-square" src="/pixels-reactjs/assets/spotnet.p" alt="footer logo" width={32} height={32} />
                </a>
            ...
            >
                ...
                <p className="mt-3 text-center">&copy; {new Date().getFullYear()} <a href="https://spotnet.tech" target="_blank">Rights Reserved</a> • Spotnet<a href="https://spotnet" target="_blank">Technologies</a></p>
            </motion.div>
        </footer>
    );
}