...
export default function ContactSection() {
    return (
        <div className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="Contact" text2="Reach out to us" text3="Ready to grow your business with digitalization? Let’s connect and build something exceptional together. We are ready to recieve your 
            message and provide a quick response in the shortest time available." />
            ...
            <form onSubmit={(e) => e.preventDefault()} className='grid sm:grid-cols-2 gap-3 sm:gap-5 max-w-2xl mx-auto text-slate-300 mt-16 w-full' >
                ...
                >
                    ...
                    <textarea name='message' rows={8} placeholder='what would you want to ask?' className='focus:border-pink-500 resize-none w-full p-3 outline-none rounded-lg border border-slate-700' />
                </motion.div>
