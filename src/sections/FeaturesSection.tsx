...
export default function FeaturesSection() {
    return (
        <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="About us " text2="What to know about Spotnet" text3="Spotnet Technologies is a forward-thinking technology company focused on building smart, efficient, and user-friendly digital solutions. We specialize in software development, web and mobile applications, and IT services tailored to meet the evolving needs of businesses and individuals.

Driven by innovation and a passion for technology, our team is committed to delivering high-quality solutions that enhance productivity, improve user experiences, and create real value. At Spotnet Technologies, we believe in turning ideas into reality through creativity, expertise, and cutting-edge technology." />
